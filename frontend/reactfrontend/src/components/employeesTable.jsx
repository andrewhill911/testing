                                            ...
                                            <Modal.Body>
                                                ...
                                                <form onSubmit={handleEdit} >
                                                    <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                                                        ...
                                                        <input type="text" value={employeeToEdit.firstName} name="firstName"onChange={handleChange}/>
                                                        <label style={{marginTop:'1rem'}}>Middle Initial</label>
                                                        <input type="text" value={employeeToEdit.middleInitial} name="middleInitial"onChange={handleChange}/>
                                                        <label style={{marginTop:'1rem'}}>Last Name</label>
                                                        <input type="text" value={employeeToEdit.lastName} name="lastName"onChange={handleChange}/>
                                                        <label style={{marginTop:'1rem'}}>Date of Birth</label>
                                                        <input type="text" value={employeeToEdit.dateOfBirth} name="dateOfBirth"onChange={handleChange}/>
                                                        <label style={{marginTop:'1rem'}}>Date of Employment</label>
                                                        <input type="text" value={employeeToEdit.dateOfEmployment} name="dateOfEmployment"onChange={handleChange}/>
